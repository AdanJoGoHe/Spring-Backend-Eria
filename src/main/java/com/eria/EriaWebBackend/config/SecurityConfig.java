package com.eria.EriaWebBackend.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  private static final String BOT_USER_AGENT = "Mozilla/5.0 (X11; Linux x86_64; rv:33.0) Gecko/20100101 Firefox/33.0";
  ...
  private RequestEntity<?> addUserAgentHeader(RequestEntity<?> request) {
    ...
    headers.add(HttpHeaders.USER_AGENT, BOT_USER_AGENT);
